...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">易购在线社群商城</a></b>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/OnlineShop"><img src="../resources/home/img/logo.png" alt="ShopCZ" /></a><span>易购社群商城</span></h1></div>
			    ...
			    <div class="search_form">
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			<input type="text" class="search_form_text" name="search_content" placeholder="请输入您想找的商品" value="${search_content }" />
