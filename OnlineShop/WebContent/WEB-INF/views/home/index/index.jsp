                      ...
                      <div id="xifan_bd1lfimg" style="width:780px;height:350px;">
                        <div >
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/aihuijia.png" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="" target="_blank">国庆节大促销</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/img/3_index.png" alt="summer来了"></a></dt>
                            <dd><h2><a href="" target="_blank"></a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/img/3c_index.png" alt="潮人说"></a></dt>
                            <dd><h2><a href="" target="_blank"></a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/img/1_index.png" alt="3c数码"></a></dt>
                            <dd><h2><a href="" target="_blank"></a></h2></dd>
                          </dl>
                        </div>
                      </div>
                        ...
                        <ul>
                            ...
                            <li style="width:158px;height:190px;">
                                <dl>
                                    ...
                                    <dd>拼单价：<em>${product.price }</em>元</dd>
                                </dl>
                            </li>
                            </c:forEach>
                        </ul>
